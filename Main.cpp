...
void InitScene01(Scene& scene)
{
	scene.AddObject(std::make_unique<Sphere>(glm::vec3{ 5, 5.0f, 3 }, 1, std::make_unique<Emissive>(color3{ 40, 40, 40 })));
	...
	scene.AddObject(std::make_unique<Plane>(glm::vec3{ 0, -0.4f, 0 }, glm::vec3{ 0, 1, 0 }, std::make_unique<Lambertian>(color3{ 40, 40, 40 })));
